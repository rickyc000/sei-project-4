...
# SECRET_KEY = '1=_(3#df(88&pq1)0x2%bru-02@+u+$@@8__w*i8w)8eo-8h1e'

if str(os.getenv('ENVIRONMENT')) == 'development':
    SECRET_KEY = '1=_(3#df(88&pq1)0x2%bru-02@+u+$@@8__w*i8w)8eo-8h1e' # should be whatever your original key was
else:
